!(function (t, e) {
    "object" == typeof exports && "undefined" != typeof module
      ...
      : "function" == typeof define && define.amd
        ? define(e)
        : ((t =
            "undefined" != typeof globalThis ? globalThis : t || self).poggers =
            e());
  })(this, function () {
    "use strict";
      ...
      H = {
        set(t, e, i) {
          ...
          n.has(e) || 0 === n.size
            ? n.set(e, i)
            : console.error(
                `Code doesn't allow more than one instance per element. Bound instance: ${Array.from(n.keys())[0]}.`,
              );
        },
    ...
    class cn extends z {
      constructor(t, e) {
        if (void 0 === Ke)
          throw new TypeError(
            "I require require Popper (https://popper.js.org)",
          );
        super(t, e),
          (this._isEnabled = !0),
          (this._timeout = 0),
